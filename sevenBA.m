function ring=sevenBA(nperiods)
% 7BA lattice, 2.2 GeV.
    d2r = pi / 180;
    ...
    SF1 = atsextupole('SF1', 0.100000, 98.385000);
    SD1 = atsextupole('SD1', 0.100000, - 105.838000);
    SD2 = atsextupole('SD2', 0.150000, -209.734000);
    SF2 = atsextupole('SF2', 0.150000, 328.795000);
    SD3 = atsextupole('SD3', 0.150000, -261.435000);
    SF3 = atsextupole('SF3', 0.150000, 304.099000);

    CELL = {D1A; SF1; D0; D1B;Q1; D2A; SD1; D2B; Q2; D3; B1; D4; SD2; D5; Q3;...
             D6; SF2; D7;RB;D8; SD3; D9; B2; D9; SD3; D8; RB; D6; SF3; D7; RB; D8;...
             SD3; D9; B2;D9;SD3; D8; RB; D6; SF3; D7; RB; D8; SD3; D9; B2; D9; SD3; ...
             D8; RB; D7;SF3; D6; RB; D8; SD3; D9; B2; D9; SD3; D8; RB; D7; SF3; D6; RB; ...
             D8; SD3; D9;B2; D9; SD3; D8;...
          RB; D7; SF2; D6;Q3; D5; SD2; D4; B1; D3; Q2; D2B; SD1; D2A; Q1; D1B; SF1; D1A};
    
    ring = repmat(CELL, nperiods, 1);
end
